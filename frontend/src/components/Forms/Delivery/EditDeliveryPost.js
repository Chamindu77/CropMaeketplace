  ...
  return (
    ...
    <form className="container mt-5">
      ...
      <div className="row align-items-center mb-3">
        <label htmlFor="modelDropdown" className="col-sm-2 col-form-label">Vehicle Model:</label>
        ...
        <label htmlFor="districtDropdown" className="col-sm-2 col-form-label">District:</label>
        <div className="col-sm-4">
